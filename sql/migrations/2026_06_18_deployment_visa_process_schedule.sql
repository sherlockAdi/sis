-- Add visa interview schedule fields and keep the visa details procedure in sync.

ALTER TABLE DEP_T04_visa_processing_details
  ADD COLUMN IF NOT EXISTS visa_interview_date DATE DEFAULT NULL AFTER passport_expiry_date,
  ADD COLUMN IF NOT EXISTS visa_interview_venue VARCHAR(255) DEFAULT NULL AFTER visa_interview_date;
